...
window.Raphael.svg && function (R) {
    ...
    addArrow = function (o, value, isEnd) {
        if (o.type == "path") {
            ...
            // TAKA EDIT // REMOVES OPACITY FOR HEADS
            let newColor = rgb2hex(o['attrs']['stroke']);
            if (newColor != null && newColor != "")
            {
                o['attrs']['stroke'] = newColor;
            }
            ...
            while (i--) {
                switch (values[i]) {
                    ...
                    case "nofill": dofill = false; break;
                }
            }
            ...
            if (type == "open") {
                ...
                if (dofill)
                {
                    attr = {
                        fill: attrs.stroke,
                        stroke: "none"
                    }; // TAKA / NOTE FOR LATER, HERE IS THE FILL
                }
                else
                {
                    attr = {
            ...
            if (type != "none") {
                ...
                var markerId = "raphael-marker-" + se + type + w + h + this.raphaelMarkerIdFixCount;
                this.raphaelMarkerIdFixCount += 1;
